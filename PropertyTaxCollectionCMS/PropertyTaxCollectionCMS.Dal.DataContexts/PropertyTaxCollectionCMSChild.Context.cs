...
namespace PropertyTaxCollectionCMS.Dal.DataContexts
{
    ...
    public partial class PropertyTaxCollectionCMSChild_Entities : DbContext
    {
        ...
        public virtual ObjectResult<string> GetMobile(Nullable<int> areaId)
        {
            var areaIdParameter = areaId.HasValue ?
                new ObjectParameter("areaId", areaId) :
                new ObjectParameter("areaId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GetMobile", areaIdParameter);
        }
        ...
        public virtual int RPT_1POINT7_DETAILS(Nullable<int> iNSERT_ID)
        {
            var iNSERT_IDParameter = iNSERT_ID.HasValue ?
                new ObjectParameter("INSERT_ID", iNSERT_ID) :
                new ObjectParameter("INSERT_ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RPT_1POINT7_DETAILS", iNSERT_IDParameter);
        }
        ...
        public virtual ObjectResult<SP_ALL_Collection_Count_Result> SP_ALL_Collection_Count()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_ALL_Collection_Count_Result>("SP_ALL_Collection_Count");
        }
    
        public virtual ObjectResult<string> sp_area()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("sp_area");
        }
    
        public virtual ObjectResult<SP_AttendHouseLocationMap_Result> SP_AttendHouseLocationMap(Nullable<int> userId, Nullable<System.DateTime> fdate, Nullable<System.DateTime> edate)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_AttendHouseLocationMap_Result>("SP_AttendHouseLocationMap", userIdParameter, fdateParameter, edateParameter);
        }
        ...
        public virtual int SP_GarbageCollection(Nullable<int> appId, Nullable<int> userid, Nullable<System.DateTime> fdate, Nullable<System.DateTime> tdate, Nullable<int> zoneId, Nullable<int> areaId, Nullable<int> wardNo)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GarbageCollection", appIdParameter, useridParameter, fdateParameter, tdateParameter, zoneIdParameter, areaIdParameter, wardNoParameter);
        }
        ...
        public virtual ObjectResult<SP_Live_Entry_Tracker_Result> SP_Live_Entry_Tracker()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Live_Entry_Tracker_Result>("SP_Live_Entry_Tracker");
        }
        ...
        public virtual ObjectResult<SP_HouseOnMapDetailsForTax_Result> SP_HouseOnMapDetailsForTax(Nullable<System.DateTime> pAYMENT_DATE, Nullable<int> userId, Nullable<int> tCAT_ID, Nullable<int> filterType)
        {
            ...
            var tCAT_IDParameter = tCAT_ID.HasValue ?
                new ObjectParameter("TCAT_ID", tCAT_ID) :
                new ObjectParameter("TCAT_ID", typeof(int));
    
            var filterTypeParameter = filterType.HasValue ?
                new ObjectParameter("FilterType", filterType) :
                new ObjectParameter("FilterType", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_HouseOnMapDetailsForTax_Result>("SP_HouseOnMapDetailsForTax", pAYMENT_DATEParameter, userIdParameter, tCAT_IDParameter, filterTypeParameter);
        }
    }
}
